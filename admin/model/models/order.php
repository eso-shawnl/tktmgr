...
class Order extends Model {
    ...
    public function edit_order_info($user,$data = array()) {
        ...
        if(is_array($data) && !empty($data) && $user>=0) {
            ...
            $order_id = $this->db->escape(isset($data['order_id']) ? $data['order_id'] : '');
            ...
            $payment_method = $this->db->escape(isset($data['payment_method']) ? $data['payment_method'] : 0);
            $deliery_type = $this->db->escape(isset($data['delivery_type']) ? $data['delivery_type'] : 0);
    ...
    public function edit_order_detail($user,$data = array()) {
        ...
        if(is_array($data) && !empty($data) && $user>=0) {
            ...
            foreach ($data as $key => $value) {
                ...
                $order_detail_row_id = $this->db->escape(isset($value['order_detail_row_id']) ? $value['order_detail_row_id'] : '');
